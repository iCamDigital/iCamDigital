...
# For custom server environment, you can use the following values:
...
BLOB_READ_WRITE_TOKEN = "" - You can keep this empty since we are not using Vercel
...
# GLOBAL PRICES (Price packages) - in USD
NEXT_PUBLIC_PRICE_ONE_CREDIT = 12
NEXT_PUBLIC_PRICE_THREE_CREDITS = 30
NEXT_PUBLIC_PRICE_FIVE_CREDITS = 40


# GLOBAL CREDITS (Credit packages)
NEXT_PUBLIC_CREDIT_PACKAGE_ONE = 1
NEXT_PUBLIC_CREDIT_PACKAGE_TWO = 3
NEXT_PUBLIC_CREDIT_PACKAGE_THREE = 5
...
# DEPLOYMENT
DEPLOYMENT_PROVIDER = vercel # or hostinger, digital ocean
