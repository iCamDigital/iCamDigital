...
To add [Google Analytics](https://analytics.google.com/) with Framecast AI, you need to replace the following environment variables in your
`env` file. This is the easiest way to get started with Google Analytics. Just follow the following steps to ensure
it works perfectly.
...
<figure>
  <>![Framecast AI](../../../assets/docs/19.png)</>
  <figcaption>
...
<figure>
  <>![Framecast AI](../../../assets/docs/20.png)</>
  <figcaption>
...
Copy both of the values and replace them in your `.env` file.
